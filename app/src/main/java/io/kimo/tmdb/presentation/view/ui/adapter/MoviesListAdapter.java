package io.kimo.tmdb.presentation.view.ui.adapter;
...
import io.kimo.tmdb.presentation.view.ui.activity.MovieDetailActivity;
...
public class MoviesListAdapter extends RecyclerView.Adapter<MoviesListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.title.setText(movieModel.getName() + " (" + movieModel.getYearOfRelease() + ")");
